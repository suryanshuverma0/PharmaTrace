...
export const PharmaChainLogo = ({ className = "w-12 h-12" }) => (
  ...
  >
    ...
    <circle cx="30" cy="30" r="28" stroke="url(#logoGradient)" strokeWidth="2" fill="none" opacity="0.3" />
    <circle cx="30" cy="30" r="22" stroke="url(#logoGradient)" strokeWidth="1.5" fill="none" opacity="0.5" />
    <rect x="26" y="18" width="8" height="24" rx="2" fill="url(#logoGradient)" />
    <rect x="18" y="26" width="24" height="8" rx="2" fill="url(#logoGradient)" />
    ...
    <path d="M18 15 L27 24" stroke="url(#logoGradient)" strokeWidth="2" opacity="0.6" />
    <path d="M42 15 L33 24" stroke="url(#logoGradient)" strokeWidth="2" opacity="0.6" />
    <path d="M18 45 L27 36" stroke="url(#logoGradient)" strokeWidth="2" opacity="0.6" />
    <path d="M42 45 L33 36" stroke="url(#logoGradient)" strokeWidth="2" opacity="0.6" />
  </svg>
);
  ...
  const features = [
    {
      icon: (
        <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 2L3 7V17C3 18.1 3.9 19 5 19H19C20.1 19 21 18.1 21 17V7L12 2Z" stroke="currentColor" strokeWidth="2" fill="none" />
    ...
    },
    {
      ...
      description: "Automated compliance and verification through intelligent blockchain smart contracts that ensure regulatory adherence",
    },
    {
      icon: (
        <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M20 21V19C20 17.9391 19.5786 16.9217 18.8284 16.1716C18.0783 15.4214 17.0609 15 16 15H8C6.93913 15 5.92172 15.4214 5.17157 16.1716C4.42143 16.9217 4 17.9391 19V21" stroke="currentColor" strokeWidth="2" />
          <circle cx="12" cy="7" r="4" stroke="currentColor" strokeWidth="2" fill="none" />
          <path d="M9 12L11 14L15 10" stroke="currentColor" strokeWidth="2" />
        </svg>
      ),
      title: "Patient Verification",
      description: "Advanced authentication system ensures that genuine medications reach verified patients safely and securely",
    },
  ];
  ...
  const roles = [
    {
      icon: (
        <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M3 21H21L18 8H6L3 21Z" stroke="currentColor" strokeWidth="2" fill="none" />
          <path d="M5 8V6C5 4.89543 5.42857 3.88721 6.17157 3.17157C6.91457 2.45593 7.95218 2 9 2H15C16.0478 2 17.0854 2.45593 17.8284 3.17157C18.5714 3.88721 19 4.89543 19 6V8" stroke="currentColor" strokeWidth="2" />
          <path d="M9 12H15M12 9V15" stroke="currentColor" strokeWidth="2" />
        </svg>
      ),
      title: "Manufacturer",
      description: "Register and track pharmaceutical production from raw materials to finished products",
    },
    {
      icon: (
        <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="1" y="3" width="15" height="13" rx="2" stroke="currentColor" strokeWidth="2" fill="none" />
          <path d="M16 8H20L23 11V16H19M16 16H19" stroke="currentColor" strokeWidth="2" />
      ...
      title: "Distributor",
      description: "Manage drug distribution and logistics with complete supply chain visibility",
    },
    {
      icon: (
        <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M3 21H21L18 8H6L3 21Z" stroke="currentColor" strokeWidth="2" fill="none" />
          <path d="M7 8V6C7 4.89543 7.42857 3.88721 8.17157 3.17157C8.91457 2.45593 9.95218 2 11 2H13C14.0478 2 15.0854 2.45593 15.8284 3.17157C16.5714 3.88721 17 4.89543 17 6V8" stroke="currentColor" strokeWidth="2" />
          <rect x="9" y="12" width="6" height="4" rx="1" stroke="currentColor" strokeWidth="2" fill="none" />
        </svg>
      ),
      title: "Pharmacy",
      description: "Verify authenticity and dispense medications with confidence and regulatory compliance",
    },
    {
      icon: (
        <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M7 20.662V19C7 17.9391 7.42143 16.9217 8.17157 16.1716C8.92172 15.4214 9.93913 15 11 15H13C14.0609 15 15.0783 15.4214 15.8284 16.1716C16.5786 16.9217 17 17.9391 17 19V20.662" stroke="currentColor" strokeWidth="2" />
        </svg>
      ),
      title: "Patient",
      description: "Access verified medication information and ensure authenticity of prescribed drugs",
    },
  ];
      ...
      <section className="overflow-hidden ">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 mx-auto max-w-7xl lg:px-8">
          <motion.div className="text-center" initial="hidden" animate="visible" variants={containerVariants}>
            ...
            <motion.h1 className="text-2xl font-bold tracking-tight text-white sm:text-4xl lg:text-[65px]" variants={itemVariants}>
              {siteConfig?.siteName}
            </motion.h1>
            <motion.p className="max-w-2xl mx-auto mt-6 text-xl leading-8 text-blue-100 sm:text-2xl" variants={itemVariants}>
              Revolutionizing pharmaceutical supply chain transparency and security through blockchain innovation
            </motion.p>
        ...
        <div className="px-6 mx-auto max-w-7xl lg:px-8">
          <motion.div className="text-center" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={containerVariants}>
            ...
            <motion.p className="max-w-2xl mx-auto mt-6 text-lg text-gray-600" variants={itemVariants}>
              Each stakeholder in the pharmaceutical supply chain has a unique role to play in ensuring medication safety and authenticity.
            </motion.p>
          </motion.div>
          <motion.div className="grid grid-cols-1 gap-8 mt-16 sm:grid-cols-2 lg:grid-cols-4" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} variants={containerVariants}>
            {roles.map((role, index) => (
              ...
              >
                ...
                <h3 className="mb-4 text-xl font-semibold text-center text-gray-900">{role.title}</h3>
                <p className="leading-relaxed text-center text-gray-600">{role.description}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
  ...
  return (
    <section className="relative py-24 overflow-hidden bg-gradient-to-r from-blue-600 to-blue-800">
      ...
      <div className="relative px-6 mx-auto max-w-7xl lg:px-8">
        <motion.div className="text-center" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={containerVariants}>
          <motion.div className="flex items-center justify-center w-24 h-24 mx-auto mb-8 text-white bg-white rounded-full bg-opacity-10" variants={itemVariants}>
            <svg className="w-12 h-12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M7.5 4.21L12 6.81L16.5 4.21M12 22.08V12M12 6.81L3.27 2.04M12 6.81L20.73 2.04" stroke="currentColor" strokeWidth="2" />
            </svg>
          </motion.div>
          <motion.h2 className="text-4xl font-bold tracking-tight text-white sm:text-[46px]" variants={itemVariants}>
            Connect Your Wallet
          </motion.h2>
          <motion.p className="max-w-2xl mx-auto mt-6 text-lg text-blue-100" variants={itemVariants}>
            Connect your MetaMask wallet to start using PharmaTrace and join the future of pharmaceutical supply chain transparency.
          </motion.p>
