...
export const PharmaChainLogo = ({ className = "w-12 h-12" }) => (
  ...
  >
    ...
    {/* Outer ring representing blockchain */}
    <circle
      cx="30"
      cy="30"
      r="28"
    ...
    {/* Connecting lines for chain effect */}
    <path
      d="M18 15 L27 24"
      stroke="url(#logoGradient)"
      strokeWidth="2"
    ...
    },
    {
      icon: (
        ...
        >
          ...
          />
          <path
            d="L14 2V8H20M16 13H8M16 17H8M10 9H8"
            stroke="currentColor"
            strokeWidth="2"
          />
        </svg>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 px-6 py-24 mx-auto max-w-7xl sm:py-48 lg:px-8">
          <motion.div
        ...
        <div className="px-6 mx-auto max-w-7xl lg:px-8">
          ...
          >
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Discover the powerful capabilities that make PharmaChain the
              leading solution for pharmaceutical supply chain management.
            </motion.p>
          </motion.div>
      ...
      <div className="relative px-6 mx-auto max-w-7xl lg:px-8">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Connect your MetaMask wallet to start using PharmaChain and join the
